    ...
    <div class="card mt-3">
        ...
        <div class="card-body">
            <asp:UpdatePanel ID="upGridView" runat="server">
                <ContentTemplate>
                    <div class="row">
                        <asp:GridView CssClass="table table-sm" ID="gvDepartamentos" runat="server" ClientIDMode="Static" AutoGenerateColumns="False" BorderStyle="None" Width="80%" Style="min-width: 75rem" OnRowCommand="gvDepartamentos_RowCommand">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Acciones" ItemStyle-Width="10%">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnDetalle" CommandArgument='<%# Eval("[IdDepartamento]") %>' runat="server" CommandName="Detalle" ToolTip="Detalle"><i class="fa-solid fa-circle-info fa-2x"></i></asp:LinkButton>
                                        <asp:LinkButton ID="btnEdit" Visible='<%# Eval("[Activo]").ToString() == "False" ? false : true %>' CommandArgument='<%# Eval("[IdDepartamento]") %>' runat="server" CommandName="Editar" ToolTip="Editar" formId="14"><i class="fa-solid fa-pen-to-square fa-2x" style="color: yellow;"></i></asp:LinkButton>
                                        <asp:LinkButton ID="btnActivate" Visible='<%# Eval("[Activo]").ToString() == "True" ? false : true %>' CommandArgument='<%# Eval("[IdDepartamento]") %>' runat="server" CommandName="Activar" ToolTip="Activar"><i class="fa-solid fa-check fa-2x" style="color: green;"></i></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
